    ...
    render() {
        return (
            this.state.isLoading ? <Loader /> :
                <Content>
                    <ImageBackground source={require('../../Assets/finalbanner/meat.jpg')} style={Styles.signUpBackground} >
                        {/* <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}> */}
                        <View style={Styles.containerSignUp} >
                            <View style={Styles.logoContainer}>
                                <Image source={require('../../Assets/logo/logoblack.png')} style={Styles.logo} />
                            </View>
                            ...
                            <CustomButton
                                title={Translate("Registration.signUp")}
                                disabled={!this.state.CheckBoxClicked}
